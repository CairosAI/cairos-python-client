...
) -> Optional[Union[HTTPValidationError, List["ChatThreadInList"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, List["ChatThreadInList"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, List['ChatThreadInList']]
    """
